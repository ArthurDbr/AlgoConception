...
public class ABR<Integer extends Comparable<Integer>> {
	protected NoeudABR<Integer> _racine;
	...
	/**
	 * Méthode récursive qui retourne le noeud précédent du noeud courant, dans l'ABR.
	 * @param noeud : le noeud considéré.
	 * @return le noeud précédent du noeud considéré, dans l'ABR.
	 */
//	public NoeudABR<Intger> noeudPrecedent(NoeudABR<Integer> noeud){
//
//	}


	/**
	 * Méthode qui supprime le noeud considéré de l'ABR.
	 * @param noeudSuppr : le noeud à supprimer de l'ABR.
	 * @return vrai si le noeud a été supprimé ; faux sinon.
	 */
//	public boolean suppressionNoeud(NoeudABR<Integer> noeudSuppr){
//
//	}

	/**
	 * Méthode qui supprime la valeur considérée de l'ABR.
	 * @param valeur : la valeur à supprimer de l'ABR.
	 * @return vrai si la valeur a été supprimée
	 * 		   (c'est-à-dire qu'elle était présente dans l'ABR) ; faux sinon.
	 */
//	public boolean suppressionValeur(V valeur){
//
//	}
